...
class Longspec350 extends TestKit(ActorSystem("longspec350-spec-test")) with ImplicitSender with FlatSpecLike with Matchers with BeforeAndAfterAll {
	...
	"The System-under-test (11)" should "AUTO-GEN-TEST (11)" in {
		...
		expectMsg(new JBus.Success())
		expectMsg(new JBus.Success())
		actorRef ! (new JBus.Publish(11, "foo"))
		expectMsg(new JBus.Success())
	...
	"The System-under-test (21)" should "AUTO-GEN-TEST (21)" in {
		...
		actorRef ! (new JBus.Publish(21, "foo"))
		expectMsg(new JBus.Error())
		expectMsg(new JBus.Error())
	...
	"The System-under-test (27)" should "AUTO-GEN-TEST (27)" in {
		...
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.DestroyConnection(27))
		expectMsg(new JBus.Success())
	...
	"The System-under-test (30)" should "AUTO-GEN-TEST (30)" in {
		...
		actorRef ! (new JBus.DestroyConnection(30))
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.Disconnect(30))
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.Disconnect(30))
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.Unsubscribe(30))
	...
	"The System-under-test (38)" should "AUTO-GEN-TEST (38)" in {
		...
		actorRef ! (new JBus.Subscribe(38))
		expectMsg(new JBus.Success())
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.CreateConnection(38))
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.CreateConnection(38))
		actorRef ! (new JBus.UnsubscribeCallback(38))
		expectMsg(new JBus.Error())
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.UnsubscribeCallback(38))
	...
	"The System-under-test (44)" should "AUTO-GEN-TEST (44)" in {
		...
		expectMsg(new JBus.Error())
		actorRef ! (new JBus.Disconnect(44))
		actorRef ! (new JBus.UnsubscribeCallback(44))
		expectMsg(new JBus.Error())
		expectMsg(new JBus.Error())
